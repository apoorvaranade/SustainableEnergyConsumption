...
public class SQLHolder {
	...
	public static final String SET_GOAL = "insert into goal values(:goalID , :homeID)";
	// join
	...
	public static final String SET_GOAL_DETAILS = "insert into goal_detail values(:goalID , :goalDetailId  , :resourceType , :consumptionLimit)";
