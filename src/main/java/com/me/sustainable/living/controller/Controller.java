...
public class Controller {
	...
	public ResponseEntity<List<AbstractEnergySource>> saveHomeResources(
			@RequestBody List<AbstractEnergySource> energyResourceList, @RequestParam(value = "homeId") int homeId) {
		logger.info("start saveHomeResources method");
	...
	public List<AbstractEnergySource> getConsumption(@RequestParam(value = "homeId") int homeId) {
		logger.info("start getConsumption method");
	...
	public ResponseEntity<List<Goal>> saveGoals(@RequestBody List<Goal> goalsList,
			@RequestParam(value = "homeId") int homeId) {
		logger.info("start saveGoals method");
	...
	public ResponseEntity<String> updateGoal(@RequestParam(value = "goalId") int goalId,
			@RequestParam(value = "resourceType") String resourceType,
			@RequestParam(value = "consumptionLimit") int consumptionLimit) {
		((UserService) delegatorService.getService(EntityType.USER)).updateGoalsForHome(goalId,
				EnergyConsumptionType.valueOf(resourceType), consumptionLimit);
